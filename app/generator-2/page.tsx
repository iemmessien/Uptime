  ...
  return (
    <DashboardLayout username={user.username}>
      <div className="container mx-auto p-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-6">Generator 2</h1>
        ...
        <Tabs defaultValue="overview" className="w-full">
          ...
          <TabsContent value="overview">
            <div className="space-y-6">
              {/* Utilization Chart */}
              <SingleUtilizationChart powerSupply="Generator 2" color="#F59E0B" />

              {/* Availability Chart */}
              <SingleAvailabilityChart powerSupply="Generator 2" color="#F59E0B" />
            </div>
          </TabsContent>
          ...
          <TabsContent value="power-availability">
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <p className="text-gray-900">
                Power availability metrics for Generator 2.
              </p>
            </div>
          </TabsContent>
          ...
          <TabsContent value="power-utilization">
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <p className="text-gray-900">
                Power utilization metrics for Generator 2.
              </p>
            </div>
          </TabsContent>
          ...
          <TabsContent value="test-run">
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <p className="text-gray-900">
                Test run data and results for Generator 2.
              </p>
            </div>
          </TabsContent>
        </Tabs>
